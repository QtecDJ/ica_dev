...
export default async function SettingsPage() {
  ...
  const getRoleInfo = (role: string) => {
    switch (role) {
      ...
      case 'coach':
        return { label: 'Coach', color: 'text-black dark:text-white', bg: 'bg-black/5 dark:bg-black/20', icon: User };
      case 'parent':
        return { label: 'Elternteil', color: 'text-gray-600 dark:text-gray-400', bg: 'bg-gray-50 dark:bg-gray-900/20', icon: User };
      default:
        return { label: 'Mitglied', color: 'text-gray-600 dark:text-gray-400', bg: 'bg-gray-50 dark:bg-gray-900/20', icon: User };
    }
  };
      ...
      <div className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-700/50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <Link
              href="/dashboard"
              className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-50 transition-all duration-200 hover:gap-3"
            >
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-gray-50">
                Einstellungen
              </h1>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 order-2 lg:order-1">
            <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden lg:sticky lg:top-24">
              {/* Profile Header */}
              ...
              <div className="relative px-4 sm:px-6 pb-4 sm:pb-6 lg:pb-8">
                <div className="flex flex-col items-center -mt-8 sm:-mt-10 lg:-mt-12">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white to-gray-100 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 dark:text-gray-300 shadow-2xl border-4 border-white dark:border-gray-800">
                  ...
                  <div className="text-center mt-3 sm:mt-4 space-y-1 sm:space-y-2">
                    ...
                    <div className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-2 sm:mt-3">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2">
            {/* Benachrichtigungen */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
              <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-gray-50">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="grid gap-3 sm:gap-4">
                  <div className="group hover:bg-gray-50 dark:hover:bg-gray-700/50 p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 border border-transparent hover:border-gray-200 dark:hover:border-gray-600">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-semibold text-gray-900 dark:text-gray-50 text-sm sm:text-base">Passwort ändern</h3>
                          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate">
                            Aktualisiere dein Passwort für mehr Sicherheit
                          </p>
                        </div>
                      </div>
                      <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg sm:rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors font-medium text-xs sm:text-sm flex-shrink-0 ml-3">
                        Ändern
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="group hover:bg-gray-50 dark:hover:bg-gray-700/50 p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 border border-transparent hover:border-gray-200 dark:hover:border-gray-600">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-semibold text-gray-900 dark:text-gray-50 text-sm sm:text-base">Aktive Sitzungen</h3>
                          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate">
                ...
                <div className="group hover:bg-gray-50 dark:hover:bg-gray-700/50 p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 border border-transparent hover:border-gray-200 dark:hover:border-gray-600">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-semibold text-gray-900 dark:text-gray-50 text-sm sm:text-base">Dunkler Modus</h3>
                    ...
                    <label className="relative inline-flex items-center cursor-pointer flex-shrink-0 ml-3">
                      ...
                      <div className="w-11 h-6 sm:w-14 sm:h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 dark:peer-focus:ring-indigo-800 rounded-full peer dark:bg-gray-700 peer-checked:after:trangray-x-5 sm:peer-checked:after:trangray-x-7 peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 sm:after:h-6 sm:after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-indigo-600 shadow-inner"></div>
                    </label>
                  </div>
                </div>
              </div>
