  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="hidden lg:inline font-medium">Einstellungen</span>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-2 w-48 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg py-2 z-50">
          {/* User Info */}
          {session?.user && (
